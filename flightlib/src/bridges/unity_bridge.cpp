...
UnityBridge::UnityBridge()
  ...
  // Check for environment variable to connect to host (for Docker)
  const char* unity_host = std::getenv("UNITY_HOST");
  if (unity_host != nullptr) {
    client_address_ = std::string("tcp://") + unity_host;
  }
