...
Position Tracking: Penalize distance from goal
Orientation Tracking: Penalize deviation from desired orientation
Velocity Tracking: Encourage smooth motion
Action Penalty: Discourage excessive control inputs
